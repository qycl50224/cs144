...
class Timer {
  private:
   ...
   size_t _initial_retransmission_timeout = 0;
   bool _timer_running = false;
  public:
  Timer (size_t initial_rto):
  _retransmission_timeout(initial_rto),
  _initial_retransmission_timeout(initial_rto) {};
  void initialization() {
    _timer = 0;
